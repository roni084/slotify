...
class AdminSignInActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSignIn.setOnClickListener {
            ...
            authenticateAdmin(email, hashPassword(password))
        }
        ...
        firestore.collection("Admins")
            ...
            .addOnSuccessListener { documents ->
                if (!documents.isEmpty) {
                    ...
                    businessType = adminDoc.getString("businessType") ?: "N/A"
                    businessName = adminDoc.getString("businessName") ?: "N/A"
                ...
                CoroutineScope(Dispatchers.IO).launch {
                    try {
                        ...
                        withContext(Dispatchers.Main) {
                            Toast.makeText(
                                this@AdminSignInActivity,
                                "Verification code sent",
                                Toast.LENGTH_SHORT
                            ).show()
                            // Navigate to VerificationPage
                            val intent = Intent(this@AdminSignInActivity, AdminVerificationPage2::class.java)
    ...
    // 🔹 Added Hashing Function for Secure Password Storage
