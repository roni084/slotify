...
class UserVerificationPage2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_user_verification_page2)
    ...
    private fun showResetPasswordDialog() {
        ...
        btnConfirm.setOnClickListener {
            ...
            firestore.collection("Users").document(email).update("password", password)
