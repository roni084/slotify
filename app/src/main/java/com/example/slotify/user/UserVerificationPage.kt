...
class UserVerificationPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_user_verification_page)
        ...
        firestore.collection("VerificationCodes").document(email).get().addOnSuccessListener { document ->
            ...
            if (enteredCode == correctCode) {
                ...
                android.os.Handler().postDelayed({
                    dialog.dismiss()
                    val intent = Intent(this@UserVerificationPage, UserHomePage::class.java)
